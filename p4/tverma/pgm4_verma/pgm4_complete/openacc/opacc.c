...
#define THRESHOLD 128                /* Max block size allowable in a process (node). */
#define PROC_SIZE 1024               /* Block size in a process. This value equals N/sqrt(P), where N is the dimension of the three matrices. */
