/*
 *   Floyd's all-pairs shortest path - MPI and OpenACC implementation
 *
 *   Shriroop Joshi (sxj156530)
 *   Modified programmed by Michael J. Quinn
 */
...
/*
 * Algorithm - column matrix implementation
 */
void compute_shortest_paths (int id, int p, dtype **a, int n)
{
   ...
   tmp = (dtype *) malloc (n * sizeof(dtype));
    #pragma acc data copy(a) create(tmp)
   for (k = 0; k < n; k++) {
